...
response = WS.sendRequest(findTestObject('usersDetailUsingGET', [('id') : 1, ('name') : 'Reginald Bogisich']))
		...
		response = WS.sendRequest(findTestObject('usersDetailUsingGET', [('id') : 2, ('name') : 'Reginald Bogisich']))
		WS.verifyElementPropertyValue(response, 'id', 1)